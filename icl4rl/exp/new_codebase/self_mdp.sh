...
#SBATCH --array=0-431 # here the number depends on number of tasks in the array, e.g. 0-11 will create 12 tasks
...
python icl4rl/exp/new_codebase/self_mdp.py --setting ${SLURM_ARRAY_TASK_ID}
"