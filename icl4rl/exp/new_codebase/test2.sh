...
#SBATCH --array=0-215 # here the number depends on number of tasks in the array, e.g. 0-11 will create 12 tasks
...
python icl4rl/exp/new_codebase/test2.py --setting ${SLURM_ARRAY_TASK_ID}
"